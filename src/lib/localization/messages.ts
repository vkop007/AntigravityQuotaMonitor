...
export const DEFAULT_MESSAGES: TranslationMap = {
  ...
  "notify.unableToDetectPortHint1":
    "1. Google account is signed in on Antigravity 2. Antigravity is running",
  "notify.unableToDetectPortHint2":
    "3. System has permission to run detection commands 4. Network/VPN connection is stable",
  ...
  "notify.nonAntigravityDetected":
    "Non-Antigravity IDE detected. Recommended to use Google API to fetch quota.",
